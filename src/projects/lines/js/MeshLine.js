;(function() {
  ...
  THREE.ShaderChunk['meshline_vert'] = [
    ...
    '    vZ = finalPosition.z;',
    // '    vFragDepth = log2( max( EPSILON, gl_Position.w + 1.0 ) ) * logDepthBufFC - 1.0; //1.0 + gl_Position.w;',
    '',
  ...
  THREE.ShaderChunk['meshline_frag'] = [
    ...
    '    float depthValue = ((depth - vZ ) / depth) * 3.0;',
    '    vec4 c = showDepth ? vec4(vec3(depthValue), 1.0) : vColor;',
  ...
  function MeshLineMaterial(parameters) {
    ...
    Object.defineProperties(this, {
      ...
      mNear: {
        enumerable: true,
        get: function() {
          return this.uniforms.mNear.value
        },
        set: function(value) {
          this.uniforms.mNear.value = value
        },
      },
      mFar: {
        enumerable: true,
        get: function() {
          return this.uniforms.mFar.value
        },
        set: function(value) {
          this.uniforms.mFar.value = value
        },
      },
      useAlphaMap: {
        enumerable: true,
      ...
      showDepth: {
        enumerable: true,
        get: function() {
          return this.uniforms.showDepth.value
        },
        set: function(value) {
          this.uniforms.showDepth.value = value
        },
      },
      opacity: {
        enumerable: true,
